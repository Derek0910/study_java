 ...
 */
@WebServlet("*.dsds")
public class CustomerController2/* 고객요청분석 */ extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     * <a href=[path]>HOME</a>
     */
   public void action2(HttpServletRequest request, HttpServletResponse response)
	  ...
	  if (url.equals("/main.do")/* || url.equals("/*.do") */) { // index.jsp가 있기에
		  ...
		  viewPage = "customer/login/register.jsp";
	  }
