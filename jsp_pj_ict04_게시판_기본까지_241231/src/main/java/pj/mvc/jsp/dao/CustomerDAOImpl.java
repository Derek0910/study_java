...
public class CustomerDAOImpl implements CustomerDAO {
	...
	public int insertCustomer(CustomerDTO dto) {
		...
		try {
			...
			// 2.SQL 작성 => prepareStatement 작성
			String sql = "INSERT INTO mvc_customer_tbl( user_id," + " user_password, " + " user_name,"
	...
	public int updateCustomer(CustomerDTO dto) {
		...
		try {
			...
			String sql = "UPDATE mvc_customer_tbl " + "SET user_password= ? ," + " user_name= ? ,"
					+ " user_birthday= ? ," + " user_address = ? ," + " user_hp= ? ," + " user_email= ? "
					+ " WHERE user_id= ? ";
