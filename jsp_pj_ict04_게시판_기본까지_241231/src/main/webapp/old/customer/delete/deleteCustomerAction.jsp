			...
			<div id="contents">
				...
				<div id="section2">
					<div id="s2_inner">
						<div class="join">
							<%
								int deleteCnt = (int)request.getAttribute("deleteCnt");
							...
							<table>
								...
								<tr>
									<td colspan="2" style="border-bottom:none">
										<br>
										<div align="right">
											<input class="inputButton" type="button" value="확인" onclick="window.location='main.do'" />
										</div>
									</td>
								</tr>
							</table>
							...
							<table>
								...
								<tr>
									<td colspan="2" style="border-bottom:none">
										<br>
										<div align="right">
											<input class="inputButton" type="button" value="재입력" onclick="window.location='deleteCustomer.do'" />
										</div>
									</td>
								</tr>
							</table>
