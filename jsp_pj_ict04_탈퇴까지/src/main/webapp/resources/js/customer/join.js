...
function confirmID(){
	...
	let url = "/jsp_pj_ict04/idConfirmAction.do?user_id=" + document.joinform.user_id.value;
	
	window.open(url, "confirm", "menubar=no, width=500, height=400, top=800, left= 200")
}
